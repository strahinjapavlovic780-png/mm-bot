...
STAFF_ROLE_ID = 1449366365701144739
LEAD_ROLE_ID = 1449366351431864384
EXECUTIVE_ROLE_ID = 1449366346084253759
VICE_PRESIDENT_ROLE_ID = 1449366343458619515
OWNER_ROLE_ID = 1449366341822845011
WELCOME_CHANNEL_ID = 1481988525359632567
INVITE_LOG_CHANNEL_ID = 1481988525359632567
VERIFIED_ROLE_ID = 1449366374475497524
...
class TicketButtons(discord.ui.View):
    ...
    async def claim(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        claimed_embed.set_footer(text="Eneba | Ticket System")
...
async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
    ...
    close_embed.set_footer(text="Eneba | Ticket Logs")
...
async def policy(ctx):
    embed = discord.Embed(
        title="💜 Eneba | Middleman Accountability & Compensation Policy",
        color=PURPLE
    )
...
class CustomFeeModal(discord.ui.Modal, title="Custom Fee Split"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            title=f"💜 Eneba | Fee Agreement – {p1}/{p2} Split",
            description=(
...
class FeeView(discord.ui.View):
    ...
    async def split_fee(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(
            title="💜 Eneba | Fee Agreement – 50/50 Split",
            description=(
                "# Middleman Fee Agreement\n\n"
    ...
    async def full_fee(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = discord.Embed(
            title="💜 Eneba | Fee Agreement – Full Payment",
            description=(
                "# Middleman Fee Agreement\n\n"
...
async def confirm(ctx, user1: discord.Member, user2: discord.Member):
    embed = discord.Embed(
        title="💜 Eneba | Official Trade Confirmation",
        description=(
...
async def about(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | About Server",
        description="""
Welcome to **Eneba** — a place where traders meet, exchange and grow together.
...
""",
    ...
    embed.set_footer(text="Eneba | Official Server")
    await ctx.send(embed=embed)
...
async def rules(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Server Rules",
        description="Welcome to **Eneba**! To keep our community safe and fun, please follow these rules:",
        color=PURPLE
    )
...
async def mmtos(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Middleman Terms of Service",
        description="Welcome to **Eneba MM Services**! To ensure **safe and fair trades**, please read the rules below carefully.",
        color=PURPLE
    )
    ...
    embed.set_footer(text="Eneba | Official Middleman Terms")
    await ctx.send(embed=embed)
...
async def value(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Official Value List",
...
async def marketrules(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Marketplace Rules",
        description="Welcome to the **Eneba Marketplace**! To ensure a **safe and fair trading environment**, please follow these rules carefully.",
        color=PURPLE
    )
...
async def staffapp(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Staff Application",
        description="""
Interested in becoming a **staff member** at **Eneba**?  
...
Thank you for your interest in helping make **Eneba** a better and safer community!
""",
        color=PURPLE
    )
...
async def tos(ctx):
    ...
    embed = discord.Embed(
        title="💜 Eneba | Server TOS",
        description=(
            "# ENEBA\n"
            "## Server Terms of Service\n\n"
            "### Welcome\n"
            "Welcome to **Eneba**. Please read the following terms before using the server.\n\n"
            "### Community Rules\n"
            ...
            "### Enjoy the Server\n"
            "Trade safely, respect others, and enjoy your time in **Eneba**."
        ),
        color=PURPLE
    )

    embed.set_footer(text="Eneba | Administration")
    await ctx.send(embed=embed)
...
async def support(ctx):
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "### Thank You\n"
            "Thank you for using **Eneba Support** 💜"
        ),
        color=PURPLE
    )

    embed.set_footer(text="Eneba | Support Team")
    await ctx.send(embed=embed)
...
async def kick(ctx, member: discord.Member, *, reason="No reason provided"):
    ...
    embed.set_thumbnail(url=member.display_avatar.url)
    embed.set_footer(text="Eneba | Moderation System")
...
async def on_member_join(member):
    ...
    welcome_embed = discord.Embed(
        ...
        description=(
            ...
            "We are happy to have you in **Eneba**.\n\n"
    ...
    welcome_embed.set_footer(text="Eneba | Welcome System")

    if welcome_channel:
        await welcome_channel.send(embed=welcome_embed)

    invite_embed = discord.Embed(
        title="📈 Eneba | New Member Joined",
        description=(
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            f"**User:** {member.mention}\n"
            f"**User ID:** {member.id}\n\n"
    ...
    invite_embed.set_footer(text="Eneba | Invite Tracker")
...
class VerifyButton(discord.ui.View):
    ...
    async def verify(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed = discord.Embed(
            title="💜 Eneba | Verification Complete",
            description=(
